...
private:
  ...
  enum seed
  {
    ...
    SEED1 = 0x7BADF01D,  // Ate bad food
    SEED2 = 0x6BADF02D,  // Ate bad food
    SEED3 = 0x5BADF03D,  // Ate bad food
    SEED4 = 0x4BADF04D,  // Ate bad food
    SEED5 = 0x3BADF05D,  // Ate bad food
  };
